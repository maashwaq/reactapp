...
To build the final jar and optimize the reactapp application for production, run:
...
Then navigate to [http://localhost:8690](http://localhost:8690) in your browser.
