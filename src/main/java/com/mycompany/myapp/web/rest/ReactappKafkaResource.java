...
@RestController
@RequestMapping("/api/reactapp-kafka")
public class ReactappKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ReactappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ReactappKafkaResource(KafkaProperties kafkaProperties) {
